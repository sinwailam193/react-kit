    ...
    let webpackConfig = {
        ...
        entry: {
            ...
            index: removeNil([
                ...
                ifDevClient(() => `webpack-hot-middleware/client?noInfo=true&quiet=true&reload=true&path=http://${config("host")}:${config("clientDevServerPort")}/__webpack_hmr`),
        ...
        plugins: removeNil([
            ...
            ifDev(() => new FriendlyErrorsPlugin()),
            ...
            rules: [
                {
                    ...
                    oneOf: removeNil([
                        // JAVASCRIPT
                        {
                            ...
                            include: removeNil([...bundleConfig.srcPaths.map(srcPath => path.resolve(appRootDir.get(), srcPath)), ifProdClient(path.resolve(appRootDir.get(), "src/html"))])
                        },
