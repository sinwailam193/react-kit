        ...
        if (result === undefined) {
            ...
            if (process.env.BUILD_FLAG_IS_DEV === "true" && process.env.BUILD_FLAG_IS_CLIENT === "true") {
                throw new Error(
                    ...
                    (i.e. code that will be executed in a browser). For configuration
                    values to be exposed to the client bundle you must ensure that the
                    path is added to the client configuration filter in the project
